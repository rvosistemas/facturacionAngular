var app = angular.module('facturacionApp.computadoresCtrl', []);

// ================================================
//   Controlador de computadores
// ================================================

app.controller('computadoresCtrl', ['$scope','$routeParams', function($scope, $routeParams){
	...
	$scope.activar('mComputadores','','Computadores','listado');
